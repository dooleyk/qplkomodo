# Registers the QPL language in Komodo.

import logging
from koUDLLanguageBase import KoUDLLanguage

log = logging.getLogger("koQPLLanguage")
#log.setLevel(logging.DEBUG)

def registerLanguage(registry):
    log.debug("Registering language QPL")
    registry.registerLanguage(KoQPLLanguage())

class KoQPLLanguage(KoUDLLanguage):
    ...
    _reg_clsid_ = "82fb3ba5-7479-4b2b-b3c3-7e1f7954dae0"
    defaultExtension = '.pg6*'
